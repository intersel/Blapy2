...
export class TemplateManager {
    ...
    async processJsonUpdate(
        ...
        try {
            ...
            console.log(`🎨 [${containerName}] processJsonUpdate started`);
            console.log(`🎨 [${containerName}] tmpContainer:`, !!tmpContainer);

            console.log(`🎨 [${containerName}] JSON data extracted:`, !!jsonDataObj);
            if (jsonDataObj) {
                console.log(`🎨 [${containerName}] JSON preview:`, JSON.stringify(jsonDataObj).substring(0, 100));
            }
            ...
            console.log(`🔄 [${containerName}] Data transformations completed`);


            const template = this._getTemplate(myContainer);
            console.log(`🎭 [${containerName}] Template found:`, !!template);
            ...
            console.info(generatedHtml)

            console.log(`🏭 [${containerName}] HTML generated, length:`, generatedHtml.length);
            console.log(`🏭 [${containerName}] HTML preview:`, generatedHtml);
