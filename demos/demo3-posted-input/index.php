...
<body id="myBlapy">
	...
	<form id="myFormPost" name="myFormPost" action="testForm.php" data-blapy-link method="POST">
	...
	<form id="myFormPut" name="myFormPut" action="testPutForm.php" data-blapy-link method="PUT">
		First name: <input type="text" name="fname"><br>
		Last name: <input type="text" name="lname"><br>
