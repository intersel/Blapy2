...
<div style="border:solid 1px green;margin:20px;padding:20px;">
	<div id="mainContainer" data-blapy-container="true" data-blapy-container-name="mainContainer"
		data-blapy-container-content="HelloWorld">

		<h1>Hello World!</h1>
		<p>This "div" block is a Blapy content.</p>
		<p> Click on the <a href="helloworld_2.php" data-blapy-link>"How is it going?"</a> link,
...
<p> As you click... you will see that the <span style="border: 1px solid green;padding:3px;">green block above</span> is
	updated<br>
...
<h2>Get Blapy...</h2>
<p><a href="https://github.com/intersel/blapy2" target="_blank"><img
			src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" style="width:10%">Get Blapy
		from GitHub</a></p>
