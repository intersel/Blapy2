...
<html id="myBlapy">
<head>
  <title id="headtitle" data-blapy-container="true" data-blapy-container-name="Title"
         data-blapy-container-content="<?php echo basename($_SERVER["SCRIPT_FILENAME"]); ?>"><?php echo $defaultTitle ?></title>
    ...
    <div class="row">
      <div class="4u 12u(mobile)">
        ...
        <ul>
          ...
          <li><span data-blapy-link="true" data-blapy-href="helloworld_4.php?id=myNiceId2" class="anchor" style="">Load with a blapy link with no routing</span>
          </li>
        </ul>
      </div>
