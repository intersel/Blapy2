 ...
 * -----------------------------------------------------------------------------------------
 */
var BlapyMotionBundle=(function(){"use strict";class l{constructor(){this.fadeInOut=this.fadeInOut.bind(this),this.rightOutIn=this.rightOutIn.bind(this)}fadeInOut(s,t){const e=parseInt(t.dataset.blapyFadeoutDelay??"")||1500,i=parseInt(t.dataset.blapyFadeinDelay??"")||1500;this._fadeOut(s,e,()=>{t.style.opacity=String(0),s.replaceWith(t),this._fadeIn(t,i)})}rightOutIn(s,t){const e=parseInt(t.dataset.blapyFadeoutDelay??"")||1500,i=parseInt(t.dataset.blapyFadeinDelay??"")||1500,a=s.getBoundingClientRect().left,y=document.documentElement.clientWidth;s.style.position="relative",s.style.overflow="hidden",s.style.left=`${a}px`,this._slideOutRight(s,y,e,()=>{t.style.opacity=String(0),t.style.overflow="hidden",t.style.position="relative",t.style.left=`${y}px`,s.replaceWith(t),this._slideInFromRight(t,a,i,()=>{t.style.position="static",t.style.left="0px"})})}_fadeOut(s,t,e){s.style.transition=`opacity ${t}ms ease`,s.style.opacity=String(0),setTimeout(()=>e?.(),t)}_fadeIn(s,t,e){s.style.transition=`opacity ${t}ms ease`,s.style.opacity=String(1),setTimeout(()=>e?.(),t)}_slideOutRight(s,t,e,i){s.style.transition=`left ${e}ms ease, opacity ${e}ms ease`,s.style.left=`${t}px`,s.style.opacity=String(0),setTimeout(()=>i?.(),e)}_slideInFromRight(s,t,e,i){s.style.transition=`left ${e}ms ease, opacity ${e}ms ease`,s.style.left=`${t}px`,s.style.opacity=String(1),setTimeout(()=>i?.(),e)}}return globalThis.Blapymotion=l,l})();
